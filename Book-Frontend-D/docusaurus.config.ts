...
const config: Config = {
  ...
  tagline: 'Comprehensive Curriculum on Vision-Language-Action Integration for Autonomous Robots',
  ...
  url: 'https://frontend-of-book.vercel.app/',
      ...
      links: [
        {
          ...
          items: [
            {
              label: 'Module 1: Physical AI & Robotics',
